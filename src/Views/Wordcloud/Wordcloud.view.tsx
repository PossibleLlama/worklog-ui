                ...
                {wordCloudData.map((word) => {
                    return (
                        <div key={word.text} className="group" >
                            <li className={`p-1 rounded-xl group-hover:bg-stone-600 text-gray-800 group-hover:text-gray-200 transition-all ease-linear cursor-default block relative ${sizeRange.find((e) => e.value === word.value)?.style}`} >
                                {word.text}
                            </li>
